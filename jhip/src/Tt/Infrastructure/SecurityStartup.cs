...
using ttdemo.Data;
using ttdemo.Models;
using ttdemo.Security;
using ttdemo.Security.Jwt;
using ttdemo.Service;
using ttdemo.Service.Mapper;
...
using AuthenticationService = ttdemo.Service.AuthenticationService;
using IAuthenticationService = ttdemo.Service.IAuthenticationService;
